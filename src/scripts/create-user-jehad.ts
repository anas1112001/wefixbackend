...
const createUser = async () => {
  try {
    ...
    const email = 'jehadabuawwad@outlook.com';
    const password = 'Test123!';
    const firstName = 'Jehad';
    const lastName = 'Abu Awwad';
    const userNumber = 'JEHAD001';
    ...
    if (existingUser) {
      ...
      const newUser = await User.create({
        ...
        userRole: UserRoles.SUPER_ADMIN,
        deviceId: 'web-browser-jehad',
        fcmToken: 'web-fcm-jehad',
      });
